...
|----------|---------|----------|
| Windows 11 | v0.3.4 beta | **[Signlytic AI Setup 0.3.4.exe](https://github.com/Iyanuoluwa007/Signlytic-Overlay/releases/download/desktop-v0.3.4/Signlytic.AI.Setup.0.3.4.exe)** (99 MB) |
